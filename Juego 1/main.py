#Original source code: https://github.com/Dan02031014/Car-Race-game
import pygame
...
#Configurar el volumen de la musica en general
volumen = 0.1
# Create some dumb Sound
cd1 = pygame.mixer.Sound('Crash1.mp3')
cd1.set_volume(volumen)

cd2 = pygame.mixer.Sound('Crash2.mp3')
cd2.set_volume(volumen)
